...
const ProjectCard = ({ gitUrl, previewUrl, imgURL, title, description }) => {
  return (
    <div>
      <div
      ...
      >
        <div className="overlay items-center justify-center absolute top-0 left-0 w-full h-full bg-opacity-0 hidden bg-[#181818] group-hover:flex grooup-hover:bg-opacity-80 transition-all duration-500">
          <Link
            href={gitUrl}
